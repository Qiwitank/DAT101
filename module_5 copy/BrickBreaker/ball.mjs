...
import libSprite from "../../../DAT101/common/libs/libSprite_v2.mjs";
...
export class TBall extends libSprite.TSprite {
  ...
  constructor(aSpriteCanvas) {
    ...
    this.#physics = new TBallPhysics(this, new lib2D.TPoint(1, -1), 4);
  }
...
//array, for loop i bricks og draw game.. 